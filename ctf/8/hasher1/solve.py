...
p = angr.Project('./hasher-1.elf', main_opts={'base_addr': base_addr}) # solved with this
...
# 012345678            21
# SPBCTF-
# SPBCTF-EXPLOR-??????-ANGRFE-
# SPBCTF-EXPLOR-ECOOL1-ANGRFE-
...
state.solver.add(bytes_list[7] == ord('E'))
state.solver.add(bytes_list[8] == ord('X'))
state.solver.add(bytes_list[9] == ord('P'))
...
print(sm.found)
for s in sm.found:
	for test in s.solver.eval_upto(data, 3000):
